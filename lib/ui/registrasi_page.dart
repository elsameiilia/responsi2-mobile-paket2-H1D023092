...
import 'package:responsi2_mobile_paket2_h1d023092/bloc/registrasi_bloc.dart';
import 'package:responsi2_mobile_paket2_h1d023092/widget/success_dialog.dart';
...
class _RegistrasiPageState extends State<RegistrasiPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('Registrasi ElsaMart'),
      ),
